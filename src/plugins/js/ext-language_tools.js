ace.define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function (e, t, i) {
  ...
  (function () {
    n.implement(this, o), this.getTokenizer = function () {
      ...
      var r = this.tokenizeTmSnippet(t.fmt, "formatString"),
        s = this,
        a = e.replace(o, function () {
          ...
          for (var e = s.resolveVariables(r, i), t = "E", n = 0; n < e.length; n++) {
            ...
            else "U" == t ? e[n] = o.toUpperCase() : "L" == t && (e[n] = o.toLowerCase())
          }
          return e.join("")
        });
      ...
      for (var i = [], n = 0; n < e.length; n++) {
        ...
        if ("string" == typeof o) i.push(o);
          ...
          if (o.skip) s(o);
            ...
            if (o.processed < n) continue;
            if (o.text) {
              var r = this.getVariableValue(t, o.text);
              r && o.fmtString && (r = this.tmStrFormat(r, o)), o.processed = n, null == o.expectIf ? r && (i.push(r), s(o)) : r ? o.skip = o.elseBranch : s(o)
      ...
      var i = e.getCursorPosition(),
        ...
        r = n.match(/^\s*/)[0];
      i.column < r.length && (r = r.slice(0, i.column));
      var s = this.tokenizeTmSnippet(t),
        a = [];
      (s = (s = this.resolveVariables(s, e)).map(function (e) {
        ...
        if ("object" == typeof e) {
          ...
          if (n || ((n = a[i] = []).index = i, n.value = ""), -1 === n.indexOf(e)) {
            n.push(e);
            var o = s.indexOf(e, t + 1);
            if (-1 !== o) {
              var r = s.slice(t + 1, o);
              r.some(function (e) {
                return "object" == typeof e
              }) && !n.value ? n.value = r : !r.length || n.value && "string" == typeof n.value || (n.value = r.join(""))
            }
          }
        }
      ...
      for (var l = 0; l < s.length; l++) {
        ...
        if ("object" == typeof p) {
          var d = p.tabstopId,
            g = s.indexOf(p, l + 1);
          if (c[d]) c[d] === p && (c[d] = null);
          else {
            var f = a[d],
              m = "string" == typeof f.value ? [f.value] : h(f.value);
            m.unshift(l + 1, Math.max(0, g - l)), m.push(p), c[d] = p, s.splice.apply(s, m), -1 === f.indexOf(p) && f.push(p)
          }
        }
      }
      var v = 0,
      ...
      var w = e.getSelectionRange(),
        T = e.session.replace(w, x),
        y = new u(e),
        S = e.inVirtualSelectionMode && e.selection.index;
      y.addTabstops(a, w.start, T, S)
      ...
      function a(e, t, i) {
        return e = s(e), t = s(t), i ? (e = t + e) && "$" != e[e.length - 1] && (e += "$") : (e += t) && "^" != e[0] && (e = "^" + e), new RegExp(e)
      }
      ...
      function c(e) {
        ...
        if (e.name) {
          var c = s[e.name];
          c && o.unregister(c), s[e.name] = e
        }
        i[t].push(e), e.tabTrigger && !e.trigger && (!e.guard && /^\w/.test(e.tabTrigger) && (e.guard = "\\b"), e.trigger = r.escapeRegExp(e.tabTrigger)), (e.trigger || e.guard || e.endTrigger || e.endGuard) && (e.startRe = a(e.trigger, e.guard, !0), e.triggerRe = new RegExp(e.trigger, "", !0), e.endRe = a(e.endTrigger, e.endGuard, !0), e.endTriggerRe = new RegExp(e.endTrigger, "", !0))
      }
      ...
      for (var t, i = [], n = {}, o = /^#.*|^({[\s\S]*})\s*$|^(\S+) (.*)$|^((?:\n*\t.*)+)/gm; t = o.exec(e);) {
        ...
        if (t[4]) n.content = t[4].replace(/^\t/gm, ""), i.push(n), n = {};
          ...
          } else "snippet" == r ? (n.tabTrigger = s.match(/^\S*/)[0], n.name || (n.name = s)) : n[r] = s
        }
      }
      return i
  ...
  (function () {
    this.attach = function (e) {
      ...
      var t = "r" == e.action[0],
        ...
        r = n.row - o,
        s = n.column - i.column;
      if (t && (r = -r, s = -s), !this.$inChange && t) {
        var a = this.selectedTabstop;
        if (a && !a.some(function (e) {
            return l(e.start, i) <= 0 && l(e.end, n) >= 0
          })) return this.detach()
      }
      for (var c = this.ranges, h = 0; h < c.length; h++) {
        var p = c[h];
        p.end.row < i.row || (t && l(i, p.start) < 0 && l(n, p.end) > 0 ? (this.removeRange(p), h--) : (p.start.row == o && p.start.column > i.column && (p.start.column += s), p.end.row == o && p.end.column >= i.column && (p.end.column += s), p.start.row >= o && (p.start.row += r), p.end.row >= o && (p.end.row += r), l(p.start, p.end) > 0 && this.removeRange(p)))
      }
      ...
      if (this.editor) {
        for (var e = this.editor.selection.lead, t = this.editor.selection.anchor, i = this.editor.selection.isEmpty(), n = this.ranges.length; n--;)
          if (!this.ranges[n].linked) {
            var o = this.ranges[n].contains(e.row, e.column),
              r = i || this.ranges[n].contains(t.row, t.column);
            if (o && r) return
          }
        this.detach()
      }
      ...
      e.forEach(function (e, i) {
        for (var n = this.$openTabstops[i] || e, a = e.length; a--;) {
          var c = e[a],
            h = s.fromPoints(c.start, c.end || c.start);
          g(h.start, t), g(h.end, t), h.original = c, h.tabstop = n, r.push(h), n != e ? n.unshift(h) : n[a] = h, c.fmtString ? (h.linked = !0, n.hasLinkedRanges = !0) : n.firstNonLinked || (n.firstNonLinked = h)
        }
  ...
  var d = {};
  d.onChange = a.prototype.onChange, d.setPosition = function (e, t) {
    this.pos.row = e, this.pos.column = t
  }, d.update = function (e, t, i) {
  ...
  var n = e("../virtual_renderer").VirtualRenderer,
    ...
    a = e("../lib/lang"),
    c = e("../lib/dom");
  c.importCssString(".ace_editor.ace_autocomplete .ace_marker-layer .ace_active-line {    background-color: #CAD6FA;    z-index: 1;}.ace_editor.ace_autocomplete .ace_line-hover {    border: 1px solid #42a9f4;    margin-top: -1px;    background: #42a9f4;}.ace_editor.ace_autocomplete .ace_line-hover {    position: absolute;    z-index: 2;}.ace_editor.ace_autocomplete .ace_scroller {   background: none;   border: none;   box-shadow: none;}.ace_rightAlignedText {    color: gray;    display: inline-block;    position: absolute;    right: 10px;    text-align: right;    z-index: -1;}.ace_editor.ace_autocomplete .ace_completion-highlight{    color: #42A9F4;    text-shadow: 0 0 0.01em;}.ace_editor.ace_autocomplete {    width: 192px;    z-index: 200000;    background: #fff;    color: #444;    border: 1px solid #dadee5;    position: fixed;    border-radius:3px;    line-height: 24px;vertical-align: top;    margin-top:11px;}.ace_editor.ace_autocomplete .ace_text-layer{  padding: 0 10px !important;}"), t.AcePopup = function (e) {
    ...
    var h, l = function () {};
    i.focus = l, i.$isFocused = !0, i.renderer.$cursorLayer.restartTimer = l, i.renderer.$cursorLayer.element.style.opacity = 0, i.renderer.$maxLines = 8, i.renderer.$keepTextAreaAtCursor = !1, i.setHighlightActiveLine(!1), i.session.highlight(""), i.session.$searchHighlight.clazz = "ace_highlight-marker", i.on("mousedown", function (e) {
      var t = e.getDocumentPosition();
      i.selection.moveToPosition(t), u.start.row = u.end.row = t.row, e.stop()
    });
    var p = new r(-1, 0, -1, 1 / 0),
      u = new r(-1, 0, -1, 1 / 0);
    u.id = i.session.addMarker(u, "ace_active-line", "fullLine"), i.setSelectOnHover = function (e) {
      e ? p.id && (i.session.removeMarker(p.id), p.id = null) : p.id = i.session.addMarker(p, "ace_line-hover", "fullLine")
    }, i.setSelectOnHover(!1), i.on("mousemove", function (e) {
      if (h) {
        if (h.x != e.x || h.y != e.y) {
          (h = e).scrollTop = i.renderer.scrollTop;
          var t = h.getDocumentPosition().row;
          p.start.row != t && (p.id || i.setRow(t), g(t))
        }
      } else h = e
    ...
    var d = function () {
      ...
      g = function (e, t) {
        e !== p.start.row && (p.start.row = p.end.row = e, t || i.session._emit("changeBackMarker"), i._emit("changeHoverMarker"))
      };
    ...
    return f.$tokenizeRow = function (e) {
      ...
      for (var o, r, s = -1, a = 0; a < t.caption.length; a++) r = t.caption[a], s !== (o = t.matchMask & 1 << a ? 1 : 0) ? (n.push({
        type: t.className || (o ? "completion-highlight" : ""),
        value: r
      }), s = o) : n[n.length - 1].value += r;
      if (t.meta) {
        var c = i.renderer.$size.scrollerWidth / i.renderer.layerConfig.characterWidth,
          h = t.meta;
      ...
      return n
    }, f.$updateOnChange = l, f.start = l, i.session.$computeWidth = function () {
      ...
      e = Math.max(-1, Math.min(this.data.length, e)), u.start.row != e && (i.selection.clearSelection(), u.start.row = u.end.row = e || 0, i.session._emit("changeBackMarker"), i.moveCursorTo(e || 0, 0), i.isOpen && i._signal("select"))
      ...
      var o = this.container,
        ...
        s = window.innerWidth,
        a = this.renderer.$maxLines * t * 1.4,
        c = e.top + this.$borderSize;
      c + a > r - t && !n ? (o.style.top = "", o.style.bottom = r - c + "px", i.isTopdown = !1) : (c += t, o.style.top = c + "px", o.style.bottom = "", i.isTopdown = !0), o.style.display = "", this.renderer.$textLayer.checkForSizeChanges();
      var l = e.left;
      l + o.offsetWidth > s && (l = s - o.offsetWidth), o.style.left = l + "px", this._signal("show"), h = null, i.isOpen = !0
  ...
  (function () {
    this.$init = function () {
      ...
      if (this.popup.setRow(this.autoSelect ? 0 : -1), i) i && !t && this.detach();
        ...
        var o = n.layerConfig.lineHeight,
          r = n.$cursorLayer.getPixelPosition(this.base, !0);
        r.left -= this.popup.getTextLeftOffset();
        var s = e.container.getBoundingClientRect();
        r.top += s.top - n.layerConfig.offset, r.left += s.left - e.renderer.scrollLeft, r.left += n.gutterWidth, this.popup.show(r, o)
      }
    }, this.detach = function () {
      ...
      t == i || t.parentNode == o || n || t == this.tooltipNode || e.relatedTarget == i || this.detach()
      ...
      if (e.completer && e.completer.insertMatch) e.completer.insertMatch(this.editor, e);
        ...
        if (this.completions.filterText)
          for (var i, n = this.editor.selection.getAllRanges(), o = 0; i = n[o]; o++) i.start.column -= this.completions.filterText.length, this.editor.session.remove(i);
  ...
  (function () {
    this.setFilter = function (e) {
      ...
      this.filterText = e;
      var i = null;
      t = (t = (t = this.filterCompletions(t, this.filterText)).sort(function (e, t) {
        ...
        if (a) {
          ...
          if (this.exactMatch) {
            ...
            for (var d = 0; d < t.length; d++) {
              var g = a.indexOf(o[d], l + 1),
                f = a.indexOf(n[d], l + 1);
              if ((c = g >= 0 && (f < 0 || g < f) ? g : f) < 0) continue e;
              (h = c - l - 1) > 0 && (-1 === l && (u += 10), u += h), p |= 1 << c, l = c
            }
          r.matchMask = p, r.exactMatch = u ? 0 : 1, r.score = (r.score || 0) - u, i.push(r)
        }
      }
      return i
    }
  ...
  function r(e, t) {
    var i, r = (i = t, e.getTextRange(n.fromPoints({
        row: 0,
        column: 0
      }, i)).split(o).length - 1),
      s = e.getValue().split(o),
  ...
  var n = e("../snippets").snippetManager,
    ...
    h = {
      getCompletions: function (e, t, i, n, o) {
        ...
        o(null, t.$mode.getCompletions(r, t, i, n))
      }
    },
    l = {
      getCompletions: function (e, t, i, o, r) {
        var s = n.snippetMap,
          a = [];
        n.getActiveScopes(e).forEach(function (e) {
          for (var t = s[e] || [], i = t.length; i--;) {
            var n = t[i],
              o = n.name || n.tabTrigger;
            o && a.push({
              caption: o,
              snippet: n.content,
  ...
  t.setCompleters = function (e) {
    ...
    p.push(e)
  }, t.textCompleter = c, t.keyWordCompleter = h, t.snippetCompleter = l;
  var u = {
      name: "expandSnippet",
      exec: function (e) {
    ...
    g = function (e) {
      var t = e.$id;
      n.files || (n.files = {}), f(t), e.modes && e.modes.forEach(g)
    },
    f = function (e) {
      if (e && !n.files[e]) {
        var t = e.replace("mode", "snippets");
        n.files[e] = {}, r.loadModule(t, function (t) {
  ...
  function m(e) {
    ...
    return e.completers.forEach(function (e) {
      e.identifierRegexps && e.identifierRegexps.forEach(function (e) {
        !t && e && (t = a.retrievePrecedingIdentifier(n, i.column, e))
      })
    }), t || a.retrievePrecedingIdentifier(n, i.column)
  }
  var v = function (e) {
      var t = e.editor,
        i = t.completer && t.completer.activated;
      if ("backspace" === e.command.name) i && !m(t) && t.completer.detach();
      else if ("insertstring" === e.command.name) {
        m(t) && !i && (t.completer || (t.completer = new o), t.completer.autoInsert = !1, t.completer.showPopup(t))
      }
    },
    b = e("../editor").Editor;
  e("../config").defineOptions(b.prototype, "editor", {
    enableBasicAutocompletion: {
      set: function (e) {
        e ? (this.completers || (this.completers = Array.isArray(e) ? e : p), this.commands.addCommand(o.startCommand)) : this.commands.removeCommand(o.startCommand)
      },
      value: !1
    },
    enableLiveAutocompletion: {
      set: function (e) {
        e ? (this.completers || (this.completers = Array.isArray(e) ? e : p), this.commands.on("afterExec", v)) : this.commands.removeListener("afterExec", v)
      },
      value: !1
    },
    enableSnippets: {
      set: function (e) {
        e ? (this.commands.addCommand(u), this.on("changeMode", d), d(0, this)) : (this.commands.removeCommand(u), this.off("changeMode", d))
      },
      value: !1
    }
  })
