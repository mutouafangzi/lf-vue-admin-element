ace.define("ace/theme/spl-light", ["require", "exports", "module", "ace/lib/dom"], function (e, c, a) {
  c.isDark = !1, c.cssClass = "ace-spl-light", c.cssText = `.ace-spl-light .ace_gutter {
    background: #F5F5F5;
    color: #999999;
  }
  ...
  .ace-spl-light .ace_layer.ace_text-layer .ace_line{
    line-height: 26px;
  }
